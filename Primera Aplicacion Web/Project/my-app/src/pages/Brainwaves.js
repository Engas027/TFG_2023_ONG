...
export function Brainwaves() {
  ...
  const [timerSecCalibration, setTimerSecCalibration] = useState(3*60); // en segundos 
  const [timerSecNeurofeedback, setTimerSecNeurofeedback] = useState(timerSecCalibration + (3*60)); // en segundos
